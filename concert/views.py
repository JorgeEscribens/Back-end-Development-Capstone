...
def songs(request):
    response = req.get("http://songs-sn-labs-jorgeescribe.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song").json()
    songs = json.loads(response["songs"])
    return render(request, "songs.html", {"songs": songs})

def photos(request):
    photos = req.get("http://pictures.15u9vrxtcfc4.us-south.codeengine.appdomain.cloud/picture").json()
